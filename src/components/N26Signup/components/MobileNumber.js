...
class MobileNumber extends Component {
  ...
  componentWillMount() {
    ...
    let code = country_list.filter(c => c.name === this.props.details.userDetails.country)
    if(code.length!=0)
  ...
  filterCountry(country) {
    ...
    // if(this.searchResult.length ===0)  this.searchResult = country_list.filter((c) => c.dial_code.toLowerCase().includes(country.toLowerCase()));
