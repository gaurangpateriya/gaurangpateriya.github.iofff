...
const flowSequence = [
  ...
  { index: 3, name: 'Create Password', component: <CreatePassword /> },
  { index: 4, name: 'Create Account', component: <CreateAccount /> },
];
...
const renderActiveComponent = (activeComponentIndex, props) => {
  const flowSequences = [
    ...
    { index: 3, name: 'Create Password', component: <CreatePassword details={{ ...props, index: 3 }} /> },
    { index: 4, name: 'Create Account', component: <CreateAccount details={{ ...props, index: 4 }} /> },
